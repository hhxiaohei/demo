...
function getTestWxApplication()
{
    $options = [
        'app_id'  => env('WX_TEST_APPID'),
        'secret'  => env('WX_TEST_SECRET'),
        'payment' => [
            'merchant_id' => env('WX_TEST_MERCHANT_ID'),
            'key'         => env('WX_TEST_KEY'),
...
return [
    ...
    'history_message_url' => 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzI4MTQzNTc2Ng%3D%3D&scene=110#wechat_redirect',
];
